...
<html lang="en">
  <head>
    ...
    <meta name="copyright" content="© 2026 HEAT Labs by SINEWAVE Development. All rights reserved.">
      ...
      <footer class="footer bg-gray-900 text-white py-10">
        <div class="container mx-auto px-10 space-y-10">
          ...
          <div class="text-center text-sm text-gray-500 space-y-1 border-t border-gray-700 pt-1">
            ...
            <p>&copy; 2026 HEAT Labs by SINEWAVE Development. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
