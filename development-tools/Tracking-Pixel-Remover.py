...
def remove_tracking_pixel(file_path):
    ...
    tracking_pixel_pattern = re.compile(
        ...
        r'<img src="https://cdn\.jsdelivr\.net/gh/HEATLabs/Website-Images@refs/heads/main/trackers/pcwstats-tracker-pixel-[a-zA-Z0-9-]+\.png" alt="" style="position:absolute;width:1px;height:1px;opacity:0;pointer-events:none;" class="heatlabs-tracking-pixel" data-page="[a-zA-Z0-9-]+">\s*',
        re.IGNORECASE,
    )
